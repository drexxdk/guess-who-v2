...
export function AvatarImage({ src, alt, className, fallbackName }: AvatarImageProps) {
  ...
  if (showFallback) {
    return (
      <div className={cn('relative overflow-hidden bg-gradient-to-br', gradientColors, className)}>
  ...
  return (
    <div className={cn('bg-muted relative overflow-hidden', className)}>
      {/* Blur placeholder */}
      {!imageLoaded && <div className={cn('absolute inset-0 animate-pulse bg-gradient-to-br', gradientColors)} />}
