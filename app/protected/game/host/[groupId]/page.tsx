...
export default function GameHostPage({ params }: { params: Promise<{ groupId: string }> }) {
            ...
            <>
              <div className="text-center space-y-4 py-8">
                ...
                <div>
                  ...
                  <Badge className="text-6xl px-12 py-6 font-mono">{gameCode}</Badge>
                </div>
              ...
              <div className="flex gap-4">
                ...
                <Button
                  onClick={() => router.push(`/protected/game/play/${gameSession.id}`)}
                  className="flex-1"
                >
